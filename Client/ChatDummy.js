...
function AturStyle() {
  var urls = UrlMain+"Endpoint/Admin/api/get_config.php?rooms=" + roomsID;
...
function GetLayananBot() {
  var url = UrlMain+"Endpoint/Admin/api/get_layanan.php?rooms=" + roomsID;
...
function getUnreadMessage(username, idsocket) {
  var url = UrlMain+"Endpoint/Admin/api/get_unreadmessageuser.php?username=" + username + "&id=" + idsocket;
  $.getJSON(url, function(data) {
    $.each(data.result, function() {
...
function get_history(username, idS) {
  ...
  var url = UrlMain+"Endpoint/Admin/api/get_history.php?username=" + username + "&rooms=" + roomsID + "&idS=" + idS + "&idAdmin=" + idAdmin;
  console.log(url);
  $.getJSON(url, function(data) {
    $areapesan.empty();
    if (data.result <= 0) {
...
function openPopup() {
  var popup = document.getElementById('popupss');
...
function unduhFile(){
    var username = $("#username").val();
  var url = UrlMain+"Endpoint/Admin/api/download_riwayat_chat.php?username="+username+"&rooms="+roomsID;
