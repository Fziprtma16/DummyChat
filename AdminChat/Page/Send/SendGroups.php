...
<div class="col-12 col-lg-12">
            ...
            <div class="app-card-header p-3 border-bottom-0">
                <div class="row align-items-center gx-3">
                  ...
                  <div class="col-auto">
                    <h4 class="app-card-title">Send Groups</h4>
                  </div><!--//col-->
                </div><!--//row-->
            </div><!--//app-card-header-->
              ...
              <div class="item border-bottom py-3">
                <div class="row justify-content-between align-items-center">
                  <div class="col-auto col-lg-12 mb-3">
                    <label for="" style="font-weight: bold;">Nama Groups :</label>
                    <input type="text" class="form-control" id="Groups" placeholder="Nama Groups" name="" value="">
                  ...
                  <div class="col text-end">
                    <a class="btn app-btn-secondary" onclick="SendGroups()" id="Kirim" href="#">Kirim</a>
                  </div><!--//col-->
                <?php }else{ ?>
                  <div class="col text-end">
...
<script src="MainJs/Send/SendGroups.js" charset="utf-8"></script>
