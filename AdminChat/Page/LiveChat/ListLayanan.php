 ...
 <div class="col-12 col-lg-12">
             ...
             <div class="app-card-header p-3 border-bottom-0">
                 <div class="row align-items-center gx-3">
                   ...
                   <div class="col-auto">
                     <h4 class="app-card-title">Layanan Bot</h4>
                   </div><!--//col-->
                 </div><!--//row-->
             </div><!--//app-card-header-->
             <div class="col-lg-12">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Layanan Bot</h5>
      ...
      <div class="col-lg-12">
        <div class="row">
          ...
          <div class="col-lg-6 mb-3">
            <input type="text" class="form-control" placeholder="Layanan" id="Layanan" name="" value="">
          </div>
          <div class="col-lg-12">
            <input type="text" class="form-control" placeholder="Direct Link" id="DirectLink" name="" value="">
          </div>
        </div>
      </div>
      </div>
    ...
    $('#DataTables').load("Page/LiveChat/TableLayanan.php");
    function AddLayanan () {
    var rooms =  $("#rooms").val();
    var nama = $("#Layanan").val();
    ...
    $.ajax({
      url : "https://dummytech.id/chat_apps/Admin/api/input_layanan.php",
      method:"POST",
      data : data,
