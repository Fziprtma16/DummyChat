...
<div class="chatbutton ">
 ...
 <div id="displaychat" style="display:none;">
   ...
   $('.fa-minus').click(function(){
      ...
      //      };
       // var socket = io('https://chat.pertamalab.com/',connectionOptions);
       	var socket = io('http://116.197.135.158:8101',{path:'/socket.io'});
  ...
  function Login(usernameLog){
    socket.emit('create-session',usernameLog);
...
log('','','you have been disconnected');
  ...
  $("#pesan").val("");
     ...
     var url = "http://116.197.135.158:11801/chat_admin/Admin/api/get_history.php?username="+username+"&id="+idS;
     $.getJSON(url,function(data){
     $.each(data.result,function(){
